           ...
           <div className='flex justify-between py-4 text-darkGrey'>
                <h1 className='text-lg font-bold'>CNAPP Dashboard</h1>
                 <div className='text-center text-lightGreyBlue'>
                     <span className='h-2 w-4 mx-2 font-medium p-2 border bg-white border-gray-300 rounded-lg cursor-pointer' onClick={handleSideBar}>
                                     Add widget <GoPlus className='inline'/>
                    </span>
                    <span className='h-2 w-4 p-2 mx-2 border bg-white border-gray-200 rounded-lg'>
                        <TbRefresh className='inline  rotate-45 text-lg'/>
                    </span>
                    <span className='h-2 w-4 p-2 mx-2 border bg-white border-gray-200 rounded-lg'>
                        <BsThreeDotsVertical className='inline text-lg'/>
                    </span>
