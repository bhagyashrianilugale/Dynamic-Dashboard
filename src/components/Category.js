    ...
    <>
      <div className='relative'>
            ...
            <div className='flex flex-wrap'>
              ...
              <div className='py-5 px-6 flex justify-center items-center flex-col bg-widgetBackgraundWhite rounded-2xl shadow-sm widget_container' onClick={()=>dispatch(changeSideBarStatus())}>
